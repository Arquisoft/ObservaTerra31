...
public class WebSteps {
    ...
    @Cuando("^voy a la página (.+) con idioma (.+)$")
    public void voy_a_la_página(String pageName, String langCode) throws Throwable {
        testBrowser.goTo("http://localhost:" + port + "/" + pageName + "/" + langCode);
    }
